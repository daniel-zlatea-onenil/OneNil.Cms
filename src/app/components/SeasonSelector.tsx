    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative inline-block">
        <select
          ...
          disabled={isPending}
          className="appearance-none bg-white border-2 border-red-600 text-slate-900 rounded-lg px-4 py-2 pr-10 font-semibold cursor-pointer hover:border-red-700 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-60 disabled:cursor-not-allowed text-base truncate max-w-[200px] sm:max-w-none"
